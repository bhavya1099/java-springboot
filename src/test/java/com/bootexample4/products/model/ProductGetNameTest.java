...
public class ProductGetNameTest {
	...
	public void retrieveNameWhenSet() {
		...
		assertEquals(expected, actual, "The name should match 'Test Product'");
	}
	...
	public void retrieveNameAfterResetting() {
		...
		String actual = product.getName();
		assertEquals(expected, actual, "The name should be updated to 'Updated Product'");
	}
	...
	public void consistencyOfNameRetrieval() {
		...
		assertEquals(expected, product.getName(), "First retrieval should return 'Consistent Product'");
		assertEquals(expected, product.getName(), "Second retrieval should return 'Consistent Product'");
		assertEquals(expected, product.getName(), "Third retrieval should return 'Consistent Product'");
	}
